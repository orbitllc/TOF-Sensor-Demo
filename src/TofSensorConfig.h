...
/***   Mounting Parameters   ***/
#define PERSON_THRESHOLD 12             // This counts folks of normal height walking through the door
#define NUM_CALIBRATION_LOOPS 20           // How many samples do we buffer for each zone - minimum is 2
